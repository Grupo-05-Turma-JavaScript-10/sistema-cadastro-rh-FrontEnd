...
export function Settings() {
  ...
  const getAvatarLetters = (nomeAtual: string) => {
    if (!nomeAtual) return "U";
    const partes = nomeAtual.trim().split(" ");
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="flex flex-col items-center gap-3">
                  <div className="w-24 h-24 rounded-full bg-gray-100 flex items-center justify-center border-2 border-dashed border-gray-300 relative overflow-hidden group cursor-pointer">
                    ...
                    {nome ? (
                      <span className="text-primary-teal text-xl font-bold">
                        {getAvatarLetters(nome)}
                      </span>
                    ) : (
                      <User
                        size={40}
                        className="text-metallic-silver group-hover:opacity-50 transition-opacity"
                      />
                    )}
                  ...
                  <button className="text-sm text-primary-teal font-medium hover:underline">
                    Alterar foto
                  </button>
                </div>
                ...
                <div className="flex-1 w-full space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-corporate-slate">
                        Nome Completo
                      </label>
                      <input
                        type="text"
          ...
          <div className="space-y-6">
            <Card>
              <div className="flex items-center gap-2 mb-6 border-b border-gray-50 pb-4">
                ...
                <h3 className="font-bold text-lg text-corporate-slate">
                  Notificações
                </h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <input
                    type="checkbox"
                    id="notif_email"
                    className="mt-1 w-4 h-4 text-primary-teal rounded border-gray-300 focus:ring-primary-teal"
                    defaultChecked
                  />
                  <label
                    htmlFor="notif_email"
                    className="text-sm text-corporate-slate cursor-pointer select-none"
                  >
                    <span className="font-medium block">Alertas por E-mail</span>
                    <span className="text-metallic-silver text-xs">
                      Receba atualizações sobre novos cadastros.
                    </span>
                  </label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  >
                    ...
                    <span className="text-metallic-silver text-xs">
                      Mostrar balão de alerta no dashboard.
                    </span>
                  </label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  >
                    ...
                    <span className="text-metallic-silver text-xs">
                      Receba notícias sobre novas features.
                    </span>
                  </label>
                </div>
              </div>
