  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <button className="w-full md:w-auto flex items-center justify-center gap-2 bg-primary-teal text-white px-4 py-2.5 rounded-lg hover:brightness-90 transition shadow-sm font-medium cursor-pointer">
          <Plus size={20} />
          Novo Cargo
        </button>
      </div>
